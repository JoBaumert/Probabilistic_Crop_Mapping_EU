...
#%%
"""
merges all available raster files for a year (--> if all countries are available it generates rasters for the entire EU) 
and calculates 90% HDI
"""
...
for year in range(2010,2019):
    ...
    print("export rasterfile expected shares EU...")
    ...
    del country_data_map_expected_shares, country_data
    gc.collect()
    ...
    #        continue
        ...
        Path(Simulated_cropshares_path+"HDIs/").mkdir(parents=True, exist_ok=True)
